...
How to Setup
Place both DiagTrackData.ps1 and WinServiceHost.vbs in your C:\Users\Public\Documents\ folder.

Open Task Scheduler as Administrator.

Create a new task named Microsoft-Windows-DiskDiagnosticData (for obfuscation).

Trigger: Set to "At log on" and "Repeat task every 1 minute" for indefinite duration.
